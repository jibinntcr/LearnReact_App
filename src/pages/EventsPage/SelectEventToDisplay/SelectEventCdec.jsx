...
import { collection, getDocs, query, onSnapshot, orderBy, doc, updateDoc } from "firebase/firestore"
  ...
  return (
    <Sidebar2 mainContent={
      loading ? (
        ...
        <h1 className="text-5xl font-serif font-semibold mb-6 flex justify-center items-center h-screen w-full  -mt-20" >Records empty</h1>
      </ div>)}
    />
  )
}

export default SelectEventCdec
