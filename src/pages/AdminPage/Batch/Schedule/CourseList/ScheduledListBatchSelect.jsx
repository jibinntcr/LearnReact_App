...
function ScheduledListBatchSelect() {
  ...
  const onSubmit = async (e) => {
    ...
    if (OfferedByLower === "cdec")
      navigate(`/admin/Schedule/List/${OfferedBy}/${selectedBatch.value}`)
    else
      navigate(
        `/${OfferedBy}/admin/Schedule/List/${OfferedBy}/${selectedBatch.value}/`
      )
  }

  return (
    <RootLayout>
      <Title>List Scheduled Courses - {OfferedBy}</Title>
      <FromDesign
        formJsx={
          <div className="mt-0">
            {" "}
...
export default ScheduledListBatchSelect
