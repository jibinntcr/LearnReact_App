...
function ScheduleBatchCusaTech() {
  ...
  useEffect(() => {
    ...
    //query
    const q = query(colRef, orderBy("scheduleAt", "desc"))
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        navigate(
          `/cusatech/admin/Schedule/cusatech/${batch}/Update/${selectedBatch.value}`
        )
      } else {
        toast.warning("")
      }
  ...
  return (
    <RootLayout>
      <Title> Update Scheduled Course - CusaTech </Title>
      <>
        {/* step bar */}
...
export default ScheduleBatchCusaTech
