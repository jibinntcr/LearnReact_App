...
function ScheduledBatch() {
  ...
  const onSubmit = async (e) => {
    ...
    if (OfferedByLower === "cdec")
      navigate(`/admin/Schedule/${OfferedBy}/Update/${selectedBatch.value}`)
    else
      navigate(
        `/${OfferedBy}/admin/Schedule/${OfferedBy}/Update/${selectedBatch.value}/`
      )
  }

  return (
    <RootLayout>
      <Title>Update scheduled Courses - {OfferedBy}</Title>
      <>
        {/* step bar */}
