...
function ScheduleCusatechCourse() {
  // State
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        const q2 = query(
          collection(db, `AcademicYear/${batch}/cusaTech`),
        ...
        navigate(
          `/cusatech/admin/Schedule/${batch}/cusatech/${selectedBatch.value}`
        )
      } else {
        toast.warning("")
      }
  ...
  return (
    <RootLayout>
      <Title> Schedule Course - Cusatech </Title>
      <>
        {/* step bar */}
...
export default ScheduleCusatechCourse
