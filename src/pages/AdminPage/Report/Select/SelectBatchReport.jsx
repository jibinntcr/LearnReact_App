...
function SelectBatchReport() {
  ...
  const onSubmit = async (e) => {
    ...
    if (OfferedBy.toLowerCase() === "cdec")
      navigate(`/admin/Report/${selectedBatch.value}/${OfferedBy}`)
    else
      navigate(`/${OfferedBy}/admin/Report/${selectedBatch.value}/${OfferedBy}`)
  }
  ...
  return (
    <RootLayout>
      <Title> Report Course - {OfferedBy}</Title>
      <>
        {/* step bar */}
...
export default SelectBatchReport
