...
function SelectCourseReportCdec() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        navigate(`/admin/Report/${batch}/cdec/${selectedBatch.value}`)
      } else {
        toast.warning("")
      }
      setLoading(false)
  ...
  return (
    <RootLayout>
      <Title> Report Course - Cdec </Title>
...
export default SelectCourseReportCdec
