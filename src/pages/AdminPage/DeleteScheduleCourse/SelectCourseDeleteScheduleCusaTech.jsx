...
function SelectCourseDeleteScheduleCusaTech() {
  ...
  // console.log(`/AcademicYear/${batch}/cusaTech`)
  //query
  ...
  const onClickDelete = async (docId, fileName) => {
    ...
    const docRef = doc(db, `/AcademicYear/${batch}/cusaTech/`, docId)
...
export default SelectCourseDeleteScheduleCusaTech
