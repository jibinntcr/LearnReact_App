...
function SelectDeleteScheduleCourse() {
  ...
  const onSubmit = async (e) => {
    ...
    navigate(`/admin/Delete/${selectedBatch.value}/${OfferedBy}`)
  }

  return (
    <RootLayout>
      <Title>Delete Schedule Courses - {OfferedBy}</Title>
      <>
        {/* step bar */}
...
export default SelectDeleteScheduleCourse
