...
function SelectCourseGradingCdec() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        navigate(`/admin/Grading/${batch}/cdec/${selectedBatch.value}`)
      } else {
        toast.warning("")
      }
      setLoading(false)
  ...
  return (
    <RootLayout>
      {
        <>
          <Title> Grading Course - Cdec </Title>
...
export default SelectCourseGradingCdec
