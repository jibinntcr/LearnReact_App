...
function SelectCourseGradingCusaTech() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        navigate(
          `/cusatech/admin/Grading/${batch}/cusaTech/${selectedBatch.value}`
        )
      } else {
        toast.warning("")
      }
  ...
  return (
    <RootLayout>
      <Title> Grading Course - CusaTech </Title>
      <>
        {/* step bar */}
...
export default SelectCourseGradingCusaTech
