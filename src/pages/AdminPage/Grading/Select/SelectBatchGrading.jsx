...
function SelectBatchGrading() {
  ...
  const onSubmit = async (e) => {
    ...
    if (OfferedBy.toLowerCase() === "cdec")
      navigate(`/admin/Grading/${selectedBatch.value}/${OfferedBy}`)
    else
      navigate(
        `/${OfferedBy}/admin/Grading/${selectedBatch.value}/${OfferedBy}`
      )
  }

  return (
    <RootLayout>
      <Title> Grading Course - {OfferedBy}</Title>
      <>
        {/* step bar */}
            ...
            <div className="w-1/3">
              <div className="relative mb-2">
                ...
                <div className="w-10 h-10 mx-auto bg-white border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
                  <span className=" flex items-center justify-center text-white w-full">
                    <MdGrading className="text-xl text-gray-600" />
                  </span>
                </div>
              </div>
...
export default SelectBatchGrading
