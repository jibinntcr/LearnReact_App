...
function SelectCourseEnrollReportCusaTech() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        navigate(
          `/cusatech/admin/Report/payment/${batch}/cusaTech/${selectedBatch.value}`
        )
      } else {
        toast.warning("")
      }
  ...
  return (
    <RootLayout>
      <Title>Enroll Report Course - CusaTech </Title>
...
export default SelectCourseEnrollReportCusaTech
