...
function SelectCourseEnrollReportCdec() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        navigate(`/admin/Report/payment/${batch}/cdec/${selectedBatch.value}`)
      } else {
        toast.warning("")
      }
      setLoading(false)
  ...
  return (
    <RootLayout>
      <Title> Enroll Report Course - Cdec </Title>
...
export default SelectCourseEnrollReportCdec
