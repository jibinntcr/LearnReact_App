...
function SelectCourseUpdateStateCusaTech() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (selectedBatch.value !== "") {
        ...
        navigate(
          `/cusatech/admin/UpdateState/${batch}/cusaTech/${selectedBatch.value}`
        )
      } else {
        toast.warning("")
      }
...
export default SelectCourseUpdateStateCusaTech
