...
function SelectBatchUpdateState() {
  ...
  const onSubmit = async (e) => {
    ...
    if (OfferedByLower === "cdec")
      navigate(`/admin/UpdateState/${selectedBatch.value}/${OfferedBy}`)
    else
      navigate(
        `/${OfferedBy}/admin/UpdateState/${selectedBatch.value}/${OfferedBy}`
      )
  }

  return (
    <RootLayout>
      <Title>Update State - {OfferedBy}</Title>
      <>
        {/* step bar */}
...
export default SelectBatchUpdateState
