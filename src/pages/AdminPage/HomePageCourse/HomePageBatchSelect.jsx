...
function HomePageBatchSelect() {
  ...
  const onSubmit = async (e) => {
    ...
    const OfferedByLower = OfferedBy.toLowerCase()

    // console.log(OfferedByLower)

    if (OfferedByLower === "cdec")
      navigate(
        `/admin/homepageEdit/courseDisplayHomeSelect/${selectedBatch.value}/${OfferedBy}`
      )
    else
      navigate(
        `/${OfferedBy}/admin/homepageEdit/courseDisplayHomeSelect/${selectedBatch.value}/${OfferedBy}`
      )
  }

  return (
    <RootLayout>
      <Title>Select Batch - {OfferedBy}</Title>
      <>
        {/* step bar */}
            ...
            <div className="w-1/3">
              <div className="relative mb-2">
                ...
                <div className="w-10 h-10 mx-auto bg-white border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
                  <span className=" flex items-center justify-center text-white w-full">
                    <CgSelect className="text-xl text-gray-600" />
                  </span>
                </div>
              </div>
                    ...
                    <div className="mb-6">
                      ...
                      <Select
                        ...
                        className="w-full
                              ...
                              required
                              outline-none
                              focus-visible:shadow-none focus:border-primary text-base"
                        options={batchList}
...
export default HomePageBatchSelect
