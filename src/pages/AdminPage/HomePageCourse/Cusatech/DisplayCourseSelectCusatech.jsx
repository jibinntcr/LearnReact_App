...
import Sidebar2 from "../../../../components/SideBar/SideBarCusatech"
import Spinner from "../../../../components/Spinner/Spinner"
import Switch from "react-switch"
import { db } from "../../../../firebase.config"

function DisplayCourseSelectCusatech() {
  ...
  const UpdateState = (targetDocId) => {
    ...
    const docRef = doc(db, `/AcademicYear/${batch}/cusaTech`, targetDocId)
    try {
...
export default DisplayCourseSelectCusatech
