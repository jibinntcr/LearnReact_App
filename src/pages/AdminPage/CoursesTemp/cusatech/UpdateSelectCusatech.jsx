...
function UpdateSelectCusatech() {
  ...
  const onSubmit = async (e) => {
    ...
    navigate(`/cusatech/admin/Course/Update/${selectedBatch.value}`)
  }

  return (
    <RootLayout>
      <Title> Update Course - CusaTech</Title>
...
export default UpdateSelectCusatech
