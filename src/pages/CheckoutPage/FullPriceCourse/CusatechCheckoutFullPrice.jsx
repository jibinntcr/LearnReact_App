...
function CusatechCheckoutFullPrice() {
  ...
  const { user, cusaTechEnrolledCourses, userDetailsIsFull, userDetails } = useUserAuth()
  ...
  const onSubmit = async () => {
    ...
    const paymentFullCusatech = httpsCallable(functions, "paymentFullCusatech")
    paymentFullCusatech({
      batch: batch,
...
export default CusatechCheckoutFullPrice