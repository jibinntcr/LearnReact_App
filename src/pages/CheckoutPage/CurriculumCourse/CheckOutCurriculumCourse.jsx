...
function CheckOutCurriculumCourse() {
  ...
  const enroll = () => {
    ...
    if (user === null) {
      ...
      const enrollCourseCdec = httpsCallable(functions, "enrollCourseCdec")
      enrollCourseCdec({
        batch: batch,
...
<>
  ...
  <div className="pt-16 grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    ...
    <div className="mt-10 bg-gray-50 rounded-lg px-4 pt-8 lg:mt-0">
      ...
      <button type="button" disabled={!canSave} onClick={enroll} className="enroll">
       Enroll
      </button>
    </div>
  </div></div>
...
export default CheckOutCurriculumCourse