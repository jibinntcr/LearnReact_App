...
function Page404() {
  ...
  return (
    <>
      ...
      />
      <div className="min-w-screen min-h-screen bg-emerald-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="mb-10 lg:mb-20">
              <p className="w-48 text-center text-6xl text-black font-bold">{(pathname.toLowerCase()).includes("cusatech") ? "CusaTech" : "CDeC"}</p>

            </div>
            <div className="mb-10 md:mb-20 text-gray-600 font-light">
              <h1 className="font-black uppercase text-3xl lg:text-5xl text-emerald-500 mb-10">
                You seem to be lost!
              </h1>
              <p>The page you're looking for isn't available.</p>
              <p>Try searching again or use the Back to Homepage button below.</p>
            </div>
            <div className="mb-20 md:mb-0">
              <Link to={(pathname.toLowerCase()).includes("cusatech") ? "/Cusatech" : "/"}>
                <button className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-emerald-500 hover:text-emerald-600">
