...
function UpdateForm() {
  ...
  const fetchData33 = async () => {
    ...
    const docRef2 = doc(db, "courses/CDEC/cdecChildren", courseId)
    ...
    if (docSnap.exists()) {
      ...
      // setcourseFacultys(docSnap.data().CourseFaculty)
      // let facultyData = docSnap.data().CourseFaculty;
  ...
  } else if (CurriculumCourse === true || CurriculumCourse === undefined) {
    CusatStudentFeeBoolean = true
  } else {
  ...
  const onSubmit = async (e) => {
    ...
    const docRef = doc(db, "courses/CDEC/cdecChildren", courseId)
    try {
    ...
    <div className="">
      {loading ? (
        ...
        <form className="w-full">
          ...
          <div className="my-6">
            <div className="pb-2">
              <label className=" left-0  text-gray-600  ">Current Image</label>
            </div>
