...
function FromDesign({ text, formJsx }) {
  return (
    <section
      className="py-10 mb-10 px-4 lg:px-16 overflow-hidden relative z-10"
      data-aos="fade-up"
      id="contact"
    >
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center text-slate-900 lg:justify-center -mx-4">
          <div
            className="w-full lg:w-1/2 xl:w-8/12 px-4"
            data-aos="fade-up"
            data-aos-delay="500"
            data-aos-duration="2000"
          >
            {text && (
              <div className="max-w-[870px] mb-12 lg:mb-0">
